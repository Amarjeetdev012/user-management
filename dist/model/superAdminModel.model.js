...
exports.delSuperAdmin = exports.create = exports.findEmail = void 0;
...
const create = (fname, lname, email, gender, password, active, role) => __awaiter(void 0, void 0, void 0, function* () {
    return yield SuperAdmin.create({ fname: fname, lname: lname, email: email, gender: gender, password: password, active, role });
});
